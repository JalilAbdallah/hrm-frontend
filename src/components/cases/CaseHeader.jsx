...
const CaseHeader = ({ totalCases, onShowFilters, userRole }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center py-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg border border-blue-100">
                  ...
                  <span className="text-blue-700 font-bold text-sm">{totalCases} Active Cases</span>
                </div>
          ...
          <div className="flex items-center space-x-4">
            <Button
              variant="outline" // Use common Button variant
